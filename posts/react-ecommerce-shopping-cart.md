...
https://github.com/toku31/react-shopping-cart  
npm start  
npm run server
...
class Cart extends Component {
  ...
  createOrder = (e) => {　// 追加
    ...
    this.props.createOrder(order);   // App.jsで作成する
  };
   　　　　　　　　  - - - - -
<div>
  <div className="cart">
      ...
      <div className="cart">
        <form onSubmit={this.createOrder}>
          <ul className="form-container">
            ...
            <li>
              <button className="button primary" type="submit"> // 作成
                Checkout
              </button>
            </li>
          </ul>
...
#### Modal & Animationを追加する 9  
react-revealをインストール: npm i react-reveal  
fade effect from bottom to Top for products  
画面の商品が下から上に現れるように表示
~~~js
// react-shopping-cart/src/components/Products.js 
import React, { Component } from 'react';
import formatCurrency from '../util';
import Fade from 'react-reveal/Fade';　 // 追加
...
~~~
カートに追加するとカートが左から右に動きながら現れる  
proceedボタンをクリックするとチェクアウトフォームが右から左に動きながら現れる
~~~js
//react-shopping-cart/src/components/Cart.js 
import React, { Component } from 'react'
import formatCurrency from '../util';
import Fade from 'react-reveal/Fade';　// 追加
